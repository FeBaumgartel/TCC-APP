...
import 'package:tcc_app/screens/agenda/widgets/agenda-semana/card-evento.dart';
import 'package:tcc_app/screens/agenda/widgets/agenda-semana/componente-semana.dart';
...
class AgendaSemanaProvider extends ChangeNotifier {
  ...
  Positioned _eventBuilder(
    ...
    return Positioned(
        ...
        child: CardEvento(event: event));
  }

  Widget renderWeeks(
      DateTime date, List<DateTime> datas) {
    EventosService eventosService = EventosService();
    return ComponenteSemana(
      events,
      date,
      eventosService,
      datas,
