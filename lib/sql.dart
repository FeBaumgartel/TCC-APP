abstract class Sql {
  static List<String> sqls = <String>[
    ...
    "CREATE TABLE eventos (id INTEGER UNSIGNED PRIMARY KEY NOT NULL ,  nome varchar(250) NOT NULL,  data datetime NOT NULL,  id_igreja INTEGER UNSIGNED NOT NULL,  created_at timestamp NULL DEFAULT NULL,  updated_at timestamp NULL DEFAULT NULL,  FOREIGN KEY (id_igreja) REFERENCES igrejas (id) ON DELETE NO ACTION)",
